...
export default function DropDown() {
  ...
  return (
    <div className="absolute right-2.5 w-52 text-right mt-4">
        <div className="absolute flex flex-col top-2.5 right-0 mt-2 w-52 rounded-xl dark:border-gray-700 dark:bg-gray-900 dark:text-white bg-white p-1 dark:shadow-sm shadow-[0_8px_24px_rgba(149,157,165,0.2)] z-50">
